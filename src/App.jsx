...
function App() {
  ...
  <img
    src="public/rap2.jpg"  // Replace with your image path or URL
    alt=""
  ...
  <div className="project-card">
    <img src="/public/Frame129.png" alt="Commnect System" className="project-img" />
    ...
    <p>A community announcement and support system using MERN stack.</p>
        ...
        <a href="#" className="card-link">
          <div className="project-card">
             <img src="/public/rap1.webp" alt="TechCare IT Services" className="project-img" />
        ...
        <a href="#" className="card-link">
          <div className="project-card">
            <img src="/public/rap4.png" alt="Toxic Till The End - Spotify Feature" className="project-img" />
        ...
        <a href="#" className="card-link">
          <div className="project-card">
            <img src="/public/rap3.jpg" alt="Colnago Bike Product" className="project-img" />
